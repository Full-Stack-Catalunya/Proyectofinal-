<?php
    class Database { 
        ...
        public function DatosEstudiantes() { 
            ...
            $sql  ="SELECT id,identificacion,nombres,apellidos,email,telefono,edad,direccion,factorrh from estudiantes ";
            $result = $conexion->db->prepare($sql);    
            $result->execute(); 
            return $result; 
        } 

        public function CrearEstudiante($identificacion,$nombres,$apellidos,$email,$telefono,$edad,$direccion,$factorrh) { 

            try {
                $conexion = Database::getInstance(); 
                $result = $conexion->db->prepare("INSERT INTO estudiantes (identificacion,nombres,apellidos,email,telefono,edad,direccion,factorrh) VALUES (:identificacion,:nombres,:apellidos,:email,:telefono,edad,direccion,factorrh)");
                $result->execute(
                                    array(
        ...
        public function editEstudiante($id) { 
            $conexion = Database::getInstance(); 
            $sql="SELECT id,identificacion,nombres,apellidos,email,telefono,edad,direccion,factorrh from estudiantes where id=:id"; 
            $result = $conexion->db->prepare($sql);     
            $params = array("id" => $id); 
        ...
        public function updateEstudiante($id,$nombres,$apellidos,$email,$telefono,$identificacion,$edad,$direccion,$factorrh) { 
